            ...
            <div className="md:col-span-1 space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-[#8dfcba]">info@raddeals.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-[#8dfcba]">+1 (555) 123-4567</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className=" text-[#8dfcba]">123 Creative Ave, Suite 101<br />San Francisco, CA 94103</p>
                </div>
              </div>
            </div>
